...
class OrderBoxWrap extends Component {
  ...
  renderButtons() {
    if (this.props.onConfirm) {
      return (<div className="table" styleName="buttons">
        ...
        <button className="td" styleName="button confirm" onClick={this.onConfirm}>确定</button>
      </div>);
    }
    return null;
  }
  ...
  render() {
    ...
    const { direction, commodityData } = this.props;
    return (
      <Dialog
        ...
        styles={dialogStyles}
      >
        <OrderDCB direction={direction} commodityData={commodityData} />
        {this.renderButtons()}
